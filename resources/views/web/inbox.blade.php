...
@section('page-js')
    <script src="{{ asset('/js/plugin/delete-table-row/delete-table-row.min.js') }}"></script>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            loadInbox();
            function loadInbox() {
                loadURL("{{ asset('/ajax/email/email-list.php') }}", $('#inbox-content > .table-wrap'))
            }
            ...
            $("#compose-mail").click(function() {
                loadURL("{{ asset('/ajax/email-compose.php') }}", $('#inbox-content > .table-wrap'));
            })
