                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-7">
                                            <div class="payment-methods">
                                                ...
                                                <img src="{{ asset('/img/invoice/paypal.png') }}" width="64" height="64" alt="paypal">
                                                <img src="{{ asset('/img/invoice/americanexpress.png') }}" width="64" height="64" alt="american express">
                                                <img src="{{ asset('/img/invoice/mastercard.png') }}" width="64" height="64" alt="mastercard">
                                                <img src="{{ asset('/img/invoice/visa.png') }}" width="64" height="64" alt="visa">
                                            </div>
                                        </div>
                                        <div class="col-sm-5">
